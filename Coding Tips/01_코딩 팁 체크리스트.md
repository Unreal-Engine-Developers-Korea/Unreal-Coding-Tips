...
- 되게 논란이 많은 키워드지만 언제 사용하는지만 알면 코드 가독성과 성능을 많이 높일 수 있음
- 밑에 사진 보면 큰 데이터를 읽어올때 Overhead를 많이 줄일 수 있는 것을 볼 수 있음 [코드 출처](https://www.youtube.com/watch?v=zBkNBP00wJE)
  - 예를들면 `FVector`나 커스텀 `UStruct` 사용할 때 도움이 많이 됨

![Untitled presentation](https://github.com/Unreal-Engine-Developers-Korea/Unreal-Coding-Tips/assets/57009810/b7718307-bd21-4ed4-8870-dcd5975d3839)
